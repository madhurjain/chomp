...
function proximity.init(pin_trig, pin_echo, average)
	local self = {}
	self.time_start = 0
	self.time_end = 0
    ...
    -- call back function called on echo
    -- measure time period for which echo pulse stays high
